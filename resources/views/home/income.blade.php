        ...
        <section class="w-100">
            ...
            <article class="balance-bg  w-100">
                ...
                <div class="balance-info pt-3 pt-lg-5 pb-3 pb-lg-5 px-3 px-lg-5 text-center text-lg-start">
                    <h2 class="fs-1 fw-bold mb-4">Hola,!</h2>
            ...
            <article class="row m-0 gx-0 gx-lg-4 px-3 px-lg-5 py-3 py-lg-5 text-black egress-article" id="egress-section">
            ...
            {{-- <article class="row m-0 gx-0 gx-lg-4 px-3 px-lg-5 py-3 py-lg-5 text-black income-article" id="egressAddForm-section">
                ...
                <form class="col-12 col-lg-10 mx-auto mt-4">
                    ...
                    <div class="row">
                        <div class="">
                            ...
                            <div class="recurrence-container mb-3" style="display: none;">
