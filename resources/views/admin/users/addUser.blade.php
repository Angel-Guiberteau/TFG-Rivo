...
@section('content')
    ...
    <main>
        <section class="container-custom p-3 pb-5">
            <article class="bg-light p-3 mt-4">
                ...
                <form action="" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="name" class="form-label">Nombre <span class="text-danger">*</span></label></label>
                        ...
                        <div class="col-md-6">
                            <label for="last_name" class="form-label">Apellido <span class="text-danger">*</span></label></label>
                            <div class="input-group">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="birth_date" class="form-label">Fecha de nacimiento <span class="text-danger">*</span></label></label>
                            <div class="input-group">
                        ...
                        <div class="col-md-6">
                            <label for="rol_id" class="form-label">Rol <span class="text-danger">*</span></label></label>
                            <div class="input-group">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="email" class="form-label">Correo electrónico <span class="text-danger">*</span></label></label>
                            <div class="input-group">
                        ...
                        <div class="col-md-6">
                            <label for="username" class="form-label">Nombre de usuario <span class="text-danger">*</span></label></label>
                            <div class="input-group">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="password" class="form-label">Contraseña <span class="text-danger">*</span></label></label>
                            <div class="input-group">
